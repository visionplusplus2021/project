...
class Notification:
    ...
    def send_notification_byemail(self,email,title,data,database):
        ...
        for d in data:
            ...
            str_row += "<tr> <td>"+str(d[2])+"</td> <td>"+str(d[13])+"</td> <td>"+str(d[14])+"</td> <td>"+str(d[1])+"</td> </tr> "
        
        


        html = """
                <table border ="1"> <caption>List of jaywalker(s) </caption> 

                <thead> 
                </thead> 
                <tbody> 
                <tr> <th>Timestamp</th> <th>Camera Name </th> <th>Boundary Name</th> <th>Video Name</th> </tr> 
                
                """+str_row+"""
                </tbody> <tfoot> <tr> <th colspan="3">Total</th> <td style="text-align:right;">"""+str(len(data))+"""</td> </tr>  </tfoot> </table>
        ...
        message["Subject"] = "Jaywalking Summary"
        text = message.as_string()
        
        port = 587   # For starttls
        smtp_server = "smtp.gmail.com"
        sender_email = "ssukreep@gmail.com"
        receiver_email = "ssukreep@gmail.com"#x["email"]#EMAIL_ADDRESS
