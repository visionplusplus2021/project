$(document).ready(function () {
  ...
  function getData()
  {
    ...
    $.ajax({
      type: 'POST',
      url: database_url+'/pedestian/get_by_filter',
      data: data,
      dataType: "text",
      success: function (data) {
        data = JSON.parse(data)
        console.log(data);
        var count_object = { '': 0, '': 0, '': 0, '': 0, '': 0 }
        var count_array = [];
        var label_array = [];
        var bgColor_array = []
        ...
        for (var i = 0; i < arrayLength; i++) {
          ...
          count_array.push(0);
          label_array.push(data[i][3]+"#"+data[i][0]);
        ...
        document.getElementById("lblRecord").innerHTML = "Total "+ totalJaywalking + " Pedestrians"
