$(document).ready(function () {
  ...
  $('#inputServer').change(function () {
    ...
    $.ajax({
      type: 'GET',
      url: database_url + "/counting_boundary/get_lane_vehicle/" + data+"_pedestrian",
  ...
  $('#applyFilter').on('click', function () {
    ...
    $.ajax({
      type: 'POST',
      url: database_url+'/pedestrian_report/get_by_filter',
      data: data,
      dataType: "text",
      success: function (data) {
        ...
        var count_object = { '': 0, '': 0, 'pedestrian': 0, '': 0, '': 0 }
  ...
  $('#generateReport').on('click', function () {
    ...
    hiddenElement.download = 'pedestrian_counting.' + 'csv';
    hiddenElement.click();
  });
