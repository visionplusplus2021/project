...
class YOLO(object):
    ...
    def detect_image(self, image):
        ...
        for i, c in reversed(list(enumerate(out_classes))):
            ...
            if predicted_class not in ['person','car','truck','bicycle','motorcycle','bus']:  # Modify to detect other classes.
            ...
            return_class_id.append(c)

        return return_boxes, return_scores, return_class_names,return_class_id
